...
const PrivacyPolicy = () => {
  return (
    <div className="my-10 px-4 sm:px-10 md:px-32">
      ...
      <p className="text-sm italic">Last updated: October 21, 2023</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Quarkle Incorporated, 100 Sudbury St, Apt 1515.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Quarkle, accessible from{" "}
            <a href="https://www.quarkle.ai" rel="external nofollow noopener" target="_blank">
      ...
      <ul>
        <li>By email: samarth@quarkle.ai</li>
      </ul>
    </div>
  );
};
